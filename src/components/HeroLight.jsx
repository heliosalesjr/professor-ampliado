...
const HeroLight = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 bg-gradient-to-br from-gray-50 via-white to-gray-100">
      {/* Background Blobs */}
      <div className="absolute inset-0 overflow-hidden z-0">
        <div 
          className="absolute bg-orange-400 rounded-full filter blur-3xl blob-1"
          style={{
            width: `${blob1.size}px`,
        ...
        />
        <div 
          className="absolute bg-blue-400 rounded-full filter blur-3xl blob-2"
          style={{
            width: `${blob2.size}px`,
      ...
      <div className="relative z-20 max-w-6xl mx-auto text-center">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-orange-600 via-orange-700 to-orange-800 text-transparent bg-clip-text leading-tight">
        ...
        >
          <div className="h-1 w-32 bg-gradient-to-r from-orange-600 to-blue-600 mx-auto"></div>
        </motion.div>
      </div>
